    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <main className="flex-1 flex flex-col items-center justify-center p-6 gap-6">
        ...
        <div className="relative w-full max-w-lg" style={{ height: '560px' }}>
          ...
          {/* Active card — AnimatePresence so exit animation plays */}
        ...
        <div className="flex items-center gap-8">
          <button
            ...
            className="w-16 h-16 rounded-full bg-white shadow-lg border-2 border-red-200 flex items-center justify-center hover:scale-110 hover:border-red-400 hover:shadow-red-100 transition-all active:scale-95"
            title="Skip"
          >
          ...
          <button
            ...
            className="w-16 h-16 rounded-full bg-white shadow-lg border-2 border-green-200 flex items-center justify-center hover:scale-110 hover:border-green-400 hover:shadow-green-100 transition-all active:scale-95"
            title="Apply"
          >
