...
export function CompanySignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await register({
        username, email: formData.email, password: formData.password,
        role: 'company', companyName: formData.companyName,
        location: formData.location, industry: formData.industry,
      });
      navigate('/login');
    } catch (err: unknown) {
